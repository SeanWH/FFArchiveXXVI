...
namespace WebView2WindowsFormsBrowser
{
    public partial class BrowserForm : Form
    {
        ...
        private List<CoreWebView2Frame> _webViewFrames = new List<CoreWebView2Frame>();
        ...
        private void WebViewFrames_DestoryedNestedIFrames(object sender, object args)
        {
            try
            {
        ...
        private void HandleWebMessage(CoreWebView2WebMessageReceivedEventArgs args, CoreWebView2Frame frame = null)
        {
            try
            {
        ...
        private void AuthenticationMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private async void ClearBrowsingData(object target, EventArgs e, CoreWebView2BrowsingDataKinds dataKinds)
        {
        ...
        private void CustomClientCertificateSelectionMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void DeferredCustomCertificateDialogMenuItem_Click(object sender, EventArgs e)
        {
            // Safeguarding the handler when unsupported runtime is used.
            try
            {
        ...
        private async void GetCookiesMenuItem_Click(object sender, EventArgs e, string address)
        {
            // <GetCookies>
        ...
        private void AddOrUpdateCookieMenuItem_Click(object sender, EventArgs e, string domain)
        {
            // <AddOrUpdateCookie>
        ...
        private void DeleteAllCookiesMenuItem_Click(object sender, EventArgs e)
        {
            this.webView2Control.CoreWebView2.CookieManager.DeleteAllCookies();
        }

        private void DeleteCookiesMenuItem_Click(object sender, EventArgs e, string domain)
        {
